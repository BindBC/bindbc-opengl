...
bool _hasARBES2Compatibility = false;
bool hasARBES2Compatibility() nothrow @nogc @safe{ return _hasARBES2Compatibility; }
...
static if(useARBES2Compatibility){
	...
	private bool loadARBES2Compatibility(SharedLib lib, GLSupport contextVersion) nothrow @nogc{
...
enum useARBGetProgramBinary = (){
	version(GL_ARB)                         return true;
	else version(GL_ARB_get_program_binary) return true;
	else return has41;
}();

bool _hasARBGetProgramBinary = false;
bool hasARBGetProgramBinary() nothrow @nogc @safe{ return _hasARBGetProgramBinary; }
...
static if(useARBGetProgramBinary){
	...
	private bool loadARBGetProgramBinary(SharedLib lib, GLSupport contextVersion) nothrow @nogc{
...
enum useARBSeparateShaderObjects = (){
	version(GL_ARB)                              return true;
	else version(GL_ARB_separate_shader_objects) return true;
	else return has41;
}();

bool _hasARBSeparateShaderObjects = false;
bool hasARBSeparateShaderObjects() nothrow @nogc @safe{ return _hasARBSeparateShaderObjects; }
...
static if(useARBSeparateShaderObjects){
	...
	private bool loadARBSeparateShaderObjects(SharedLib lib, GLSupport contextVersion) nothrow @nogc{
...
enum useARBVertexAttrib64Bit = (){
	version(GL_ARB)                          return true;
	else version(GL_ARB_vertex_attrib_64bit) return true;
	else return has41;
}();

bool _hasARBVertexAttrib64Bit = false;
bool hasARBVertexAttrib64Bit() nothrow @nogc @safe{ return _hasARBVertexAttrib64Bit; }
...
static if(useARBVertexAttrib64Bit){
	...
	private bool loadARBVertexAttrib64Bit(SharedLib lib, GLSupport contextVersion) nothrow @nogc{
...
//ARB_viewport_array
enum useARBViewportArray = (){
	version(GL_ARB)                     return true;
	else version(GL_ARB_viewport_array) return true;
	else return has41;
}();

bool _hasARBViewportArray = false;
bool hasARBViewportArray() nothrow @nogc @safe{ return _hasARBViewportArray; }
...
static if(useARBViewportArray){
	...
	private bool loadARBViewportArray(SharedLib lib, GLSupport contextVersion) nothrow @nogc{
...
package(bindbc.opengl) bool loadARB41(SharedLib lib, GLSupport contextVersion) nothrow @nogc{
	static if(has41){
